...
function put_vals(dest_reg,val_ans_given){//val_ans_given is a number
	...
	else if (dest_reg.indexOf("i11") > -1) { document.getElementById('i11').innerHTML=val_ans; i11 = val_ans_given;}
	else if (dest_reg.indexOf("i12") > -1) { document.getElementById('i12').innerHTML=val_ans; i12 = val_ans_given;}
	else if (dest_reg.indexOf("i13") > -1) { document.getElementById('i13').innerHTML=val_ans; i13 = val_ans_given;}
	else if (dest_reg.indexOf("i14") > -1) { document.getElementById('i14').innerHTML=val_ans; i14 = val_ans_given;}
	else if (dest_reg.indexOf("i15") > -1) { document.getElementById('i15').innerHTML=val_ans; i15 = val_ans_given;}
	else if (dest_reg.indexOf("i1") > -1) { document.getElementById('i1').innerHTML=val_ans; i1 = val_ans_given;}
	...
	else if (dest_reg.indexOf("i4") > -1) { document.getElementById('i4').innerHTML=val_ans; i4 = val_ans_given;}
	else if (dest_reg.indexOf("i5") > -1) { document.getElementById('i5').innerHTML=val_ans; i5 = val_ans_given;}
	else if (dest_reg.indexOf("i6") > -1) { document.getElementById('i6').innerHTML=val_ans; i6 = val_ans_given;}
	else if (dest_reg.indexOf("i7") > -1) { document.getElementById('i7').innerHTML=val_ans; i7 = val_ans_given;}
	else if (dest_reg.indexOf("i8") > -1) { document.getElementById('i8').innerHTML=val_ans; i8 = val_ans_given;}
	else if (dest_reg.indexOf("i9") > -1) { document.getElementById('i9').innerHTML=val_ans; i9 = val_ans_given;}
	else if (dest_reg.indexOf("i10") > -1) { document.getElementById('i10').innerHTML=val_ans; i10 = val_ans_given;}
}
/*--------------------------------------------------------------------------------------------------------------*/
...
{	
	...
	function implement_cmp(str,check_bit) {
...
function reset_regs(){
	...
	var data_regs = ["d00","d01","d02","d03","n00","n01","n02","n03"];
	for (i=0;i<data_regs.length;i++){
		document.getElementById(data_regs[i]).innerHTML="";
	}
	r0 = "err",r1 = "err",r2 = "err",r3 = "err",r4 = "err",r5 = "err",r6 = "err",r7 = "err",r8 = "err",r9 = "err",r10 = "err",r11 = "err",
...
function change_format(){
	...
	var all_regs = ["r0","r1","r2","r3","r4","r5","r6","r7","r8","r9","r10","r11","r12","sp","lr","pc","i0","i1","i2","i3","i4","i5","i6","i7","i8","i9","i10","i11","i12","i13","i14","i15"];
